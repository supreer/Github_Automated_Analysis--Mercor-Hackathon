...
#OPENAI_API_KEY = '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'
...
def main(github_url):
    ...
    with tempfile.TemporaryDirectory() as local_path :
        #local_path = r'C:\Users\sreer\Desktop\Python Files\temp_folder'
            ...
            while True:
                try:
                    ...
                    if user_question.lower() == "exit()":
                        break
                    print('Thinking...')
                    user_question = "What is the percentage of complexity of the repo out of 100?"
